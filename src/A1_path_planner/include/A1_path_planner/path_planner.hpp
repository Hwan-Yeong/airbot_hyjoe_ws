...
#ifndef A1_PATH_PLANNER__PATH_PLANNER_HPP_
#define A1_PATH_PLANNER__PATH_PLANNER_HPP_
...
protected:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("A1_path_planner")};
  std::string global_frame_, name_;
  bool use_final_approach_orientation_;

  std::vector<std::pair<double, double>> offset_arr = { 
    {0.3,0.0},    // north
    {-0.3,0.0},   // south
    {0.0,0.3},    // east
    {0.0,-0.3},   // west
  ...
  linearInterpolation(const std::vector<coordsW> &raw_path,
...
#endif //  A1_PATH_PLANNER__THETA_STAR_PLANNER_HPP_
