...
namespace explore {
    ...
    public:
         ...
         */
        bool is_unsafe_to_plan() const {
            return !(is_safe(src_.x, src_.y)) || !(is_safe(dst_.x, dst_.y));
        }
    ...
    protected:
         ...
         */
        void reset_parent(tree_node *curr_data);
         ...
         */
        void set_neighbors(const tree_node *curr_data);
         ...
         */
        bool is_safe(const int &cx, const int &cy, double &cost) const {
            double curr_cost = get_cost(cx, cy);
         ...
         */
        inline double get_cost(const int &cx, const int &cy) const {
         ...
         */
        inline double get_traversal_cost(const int &cx, const int &cy) {
            double curr_cost = get_cost(cx, cy);
         ...
         */
        inline double get_euclidean_cost(const int &ax, const int &ay, const int &bx, const int &by) {
         ...
         */
        inline double get_h_cost(const int &cx, const int &cy) {
         ...
         * @return the result of the check
         */
        inline bool within_limits(const int &cx, const int &cy) const {
         ...
         * @return the result of the check
         */
        inline bool is_goal(const tree_node &this_node) const {
         ...
         */
        void initialize_pose(int size_inc = 0);
         ...
         */
        inline void add_index(const int &cx, const int &cy, tree_node *node_this) {
         ...
         */
        inline tree_node *get_index(const int &cx, const int &cy) {
         ...
         */
        void add_to_nodes_data(const int &id_this) {
