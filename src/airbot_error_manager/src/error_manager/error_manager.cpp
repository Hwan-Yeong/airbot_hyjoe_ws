...
void ErrorManager::leftMotorStuckErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        ...
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "leftMotorStuckErrorCallback");
        #endif
    }
}
...
void ErrorManager::rightMotorStuckErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "rightMotorStuckErrorCallback");
        #endif
    }
}
...
void ErrorManager::scanDirtyFrontErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "scanDirtyFrontErrorCallback");
        #endif
    }
}
...
void ErrorManager::scanDirtyBackErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "scanDirtyBackErrorCallback");
        #endif
    }
}
...
void ErrorManager::dockingStationErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "dockingStationErrorCallback");
        #endif
    }
}
...
void ErrorManager::chargingErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "chargingErrorCallback");
        #endif
    }
}
...
void ErrorManager::batChargingOverCurrentErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "batChargingOverCurrentErrorCallback");
        #endif
    }
}
...
void ErrorManager::batDischargingOverCurrentErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "batDischargingOverCurrentErrorCallback");
        #endif
    }
}
...
void ErrorManager::topTofErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "topTofErrorCallback");
        #endif
    }
}
...
void ErrorManager::cameraErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "cameraErrorCallback");
        #endif
    }
}
...
void ErrorManager::rightMotorErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "rightMotorErrorCallback");
        #endif
    }
}
...
void ErrorManager::leftMotorErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "leftMotorErrorCallback");
        #endif
    }
}
...
void ErrorManager::scanFrontErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "scanFrontErrorCallback");
        #endif
    }
...
void ErrorManager::scanBackErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "scanBackErrorCallback");
        #endif
    }
}
...
void ErrorManager::batOverHeatErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "batOverHeatErrorCallback");
        #endif
    }
}
...
void ErrorManager::botTofErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "botTofErrorCallback");
        #endif
    }
}
...
void ErrorManager::unReachableGoalErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "unReachableGoalErrorCallback");
        #endif
    }
}
...
void ErrorManager::changeTempGoalErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "changeTempGoalErrorCallback");
        #endif
    }
}
...
void ErrorManager::fallDownErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "fallDownErrorCallback");
        #endif
    }
}
...
void ErrorManager::unableToDockingErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "unableToDockingErrorCallback");
        #endif
    }
}
...
void ErrorManager::boardOverHeatErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "boardOverHeatErrorCallback");
        #endif
    }
}
...
void ErrorManager::stationOverHeatErrorCallback(const std_msgs::msg::Bool::SharedPtr msg)
{
    ...
    if (msg->data) {
        updateErrorLists(rank, errorCode);
        #if DEBUG_LOG > 0
		RCLCPP_INFO(this->get_logger(), "stationOverHeatErrorCallback");
        #endif
    }
}
