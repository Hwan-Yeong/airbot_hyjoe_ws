...
private:
    ...
    std::chrono::time_point<std::chrono::steady_clock> last_imu_time_;
    std::chrono::time_point<std::chrono::steady_clock> no_odom_detected_time_;
    std::chrono::time_point<std::chrono::steady_clock> no_imu_detected_time_;

    // Flags for first message reception
    bool first_odom_received_ = false;
    bool first_imu_received_ = false;
    int m_no_odom_data_msg_latch = 0;
    int m_no_imu_data_msg_latch = 0;
};
