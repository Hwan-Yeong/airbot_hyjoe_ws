...
{
public:
  scanMerger() : Node("airbot_lidar_merger")
    {
        initialize_params();
        refresh_params();
...
//      RCLCPP_INFO(this->get_logger(),"No significant movement detected forseconds. Stopping exploration.");
  ...
  void initialize_params()
  {
    ...
    this->declare_parameter("laser1AngleMin", 60.0);
    this->declare_parameter("laser1AngleMax", 300.0);
    ...
    this->declare_parameter("laser2AngleMin", 60.0);
    this->declare_parameter("laser2AngleMax", 300.0);
  ...
  void refresh_params()
  {
    this->get_parameter_or<std::string>("pointCloudTopic", cloudTopic_, "cloud_in");
    ...
    this->get_parameter_or<float>("laser1AngleMin", laser1AngleMin_, 60.0);
    this->get_parameter_or<float>("laser1AngleMax", laser1AngleMax_, 300.0);
    ...
    this->get_parameter_or<float>("laser2AngleMin", laser2AngleMin_, 60.0);
    this->get_parameter_or<float>("laser2AngleMax", laser2AngleMax_, 300.0);
